...
public class AdminNoticeUpdateRequest {
    ...
    @Size(max = 200, message = "공지사항 제목은 최대 200자까지 입력 가능합니다.", groups = ValidationGroups.SizeGroup.class)
    private String noticeTitle;

    @NotBlank(message = "공지사항 내용은 비워둘 수 없습니다.", groups = ValidationGroups.NotBlankGroup.class)
    @Size(max = 3000, message = "공지사항 내용은 최대 3000자까지 입력 가능합니다.", groups = ValidationGroups.SizeGroup.class)
