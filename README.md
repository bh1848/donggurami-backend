...
백엔드 개발자로서 인증/보안, Redis 기반 토큰 저장, AWS 인프라 구성 등  
서비스 전체의 핵심 구조를 직접 설계하고 운영한 경험을 쌓을 수 있었습니다.

또한 이 프로젝트를 통해 S3, RDS, NGINX 기반 서버 환경을 처음으로 구축해보며  
파일 업로드/다운로드, 이미지 관리, 실서비스 인프라 구성에 대한 이해를 크게 확장할 수 있었습니다.  
이전에 진행했던 Suchat 프로젝트의 JWT 경험이 기반이 되어,  
이번에는 더 안정적이고 구조적인 인증·보안 시스템을 구성할 수 있었습니다.

특히 이미지 업로드와 같은 기능은 처음 다뤄보는 영역이었지만  
S3 연동을 통해 자연스럽게 학습할 수 있었고,  
보안적으로 고려해야 할 요소들이 훨씬 많다는 점도 프로젝트를 통해 깨닫게 되었습니다.  
이 프로젝트는 아키텍처를 설계할 때 더 넓은 시야를 갖게 해주는 중요한 경험이 되었습니다.
